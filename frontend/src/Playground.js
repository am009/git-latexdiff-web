import { Box, Text, Link, Octicon, Heading } from '@primer/react'
import {
    MarkGithubIcon,
    CheckIcon,
    CommentIcon,
...
function Playground() {
  ...
  */
    ...
    return (
        ...
        >
            <Heading><Link href="https://github.com/am009/git-latexdiff-web">git-latexdiff web</Link></Heading>
            <Text>An online tool for <Link target="_blank" href="https://github.com/ftilmann/latexdiff">latexdiff</Link> and <Link target="_blank" href="https://gitlab.com/git-latexdiff/git-latexdiff">git-latexdiff</Link>.</Text>
            <Box
                sx={{
                    maxWidth: 600,
                    width: '100%',
