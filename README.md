...
Then you will get the following file structure:

- \<path-to-folder\>/
  - `diff.pdf`: the diff result.
  - `git-latexdiff`: the temp folder for `git-latexdiff`
    - `new`: new project but the main tex is generated by latexdiff.
      - `main.tex`: generated by `latexdiff old-main-fl.tex new-main-fl.tex > main.tex`.
      - `main.tex.orig`: The backup original main.tex.
    - `old`: old project
    - `old-main-fl.tex`: expanded old project tex.
